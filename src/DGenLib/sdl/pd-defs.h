...
#define PDK_KP7 SDLK_KP_7
#define PDK_KP8 SDLK_KP_8
#define PDK_KP9 SDLK_KP_9
#define PDK_KP_MINUS SDLK_KP_MINUS
#define PDK_KP4 SDLK_KP_4
#define PDK_KP5 SDLK_KP_5
#define PDK_KP6 SDLK_KP_6
#define PDK_KP_PLUS SDLK_KP_PLUS
#define PDK_KP1 SDLK_KP_1
#define PDK_KP2 SDLK_KP_2
#define PDK_KP3 SDLK_KP_3
#define PDK_KP0 SDLK_KP_0
